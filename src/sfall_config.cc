...
bool modConfigInit(int argc, char** argv)
{
    ...
    configSetBool(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_FLOAT_AUDIO_KEY, MOD_CONFIG_DEFAULT_FLOAT_AUDIO);
    ...
    // sfall_config.h.
    configSetBool(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_TEXT_SCRAMBLE_KEY, MOD_CONFIG_DEFAULT_TEXT_SCRAMBLE);
    configSetInt(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_TEXT_SCRAMBLE_DISTANCE_PER_PERCEPTION_KEY, MOD_CONFIG_DEFAULT_TEXT_SCRAMBLE_DISTANCE_PER_PERCEPTION);
    configSetInt(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_TEXT_SCRAMBLE_OBSTRUCTION_DAMPENING_KEY, MOD_CONFIG_DEFAULT_TEXT_SCRAMBLE_OBSTRUCTION_DAMPENING);
    configSetString(&gModConfig, MOD_CONFIG_VOCK_FEATURES_KEY, MOD_CONFIG_TEXT_SCRAMBLE_CHARS_KEY, MOD_CONFIG_DEFAULT_TEXT_SCRAMBLE_CHARS);
